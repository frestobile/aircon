...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_conversionId":"611873181",
      "vtp_conversionLabel":"611873181",
      "vtp_rdp":false,
      "vtp_url":["macro",2],
      ...
      "vtp_conversionCookiePrefix":"_gcl",
      "vtp_conversionId":"611873181",
      "vtp_conversionLabel":"pCeiCJ2ruNkBEJ3j4aMC",
      "vtp_rdp":false,
      "vtp_url":["macro",2],
      "vtp_enableProductReportingCheckbox":true,
      "vtp_enableNewCustomerReportingCheckbox":false,
      ...
      "vtp_uniqueTriggerId":"31967014_9",
      "tag_id":12
    }],
  "predicates":[{
      "function":"_eq",
      ...
      "function":"_cn",
      "arg0":["macro",1],
      "arg1":"airconranger.com\/mail.php"
    },{
      "function":"_cn",
      "arg0":["macro",4],
      "arg1":"tel:"
...
return null},$c=!1;if(H.querySelectorAll)try{var ad=H.querySelectorAll(":root");ad&&1==ad.length&&ad[0]==H.documentElement&&($c=!0)}catch(a){}var Xc=$c;var od={},K=null,pd=Math.random();od.s="GTM-5STNV9S";od.Pb="7v1";od.Pd="";var qd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},ud="www.googletagmanager.com/gtm.js";
var vd=ud,wd=null,xd=null,yd="//www.googletagmanager.com/a?id="+od.s+"&cv=3",zd={},Ad={},Bd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
var Ag=function(a){var b;b||(b=ce("gtm.whitelist"));b&&E(9);
...
n(d,f.targetConfig[c.aa]);break;case "event":Bj(this,c.h[1],c.h[0],c)}this.h.shift()}};var Cj="HA GF GP G UA AW DC".split(" "),Dj=!1,Ej={},Fj=!1;function Gj(a,b){var c={event:a};b&&(c.eventModel=n(b),b[C.Ac]&&(c.eventCallback=b[C.Ac]),b[C.Kb]&&(c.eventTimeout=b[C.Kb]));return c}var Ij=function(){return Dj};
var Kj={config:function(a){},event:function(a){var b=a[1];if(g(b)&&!(3<a.length)){var c;if(2<a.length){if(!Ra(a[2])&&
void 0!=a[2])return;c=a[2]}var d=Gj(b,c);return d}},js:function(a){if(2==a.length&&a[1].getTime)return Fj=!0,Ij(),{event:"gtm.js","gtm.start":a[1].getTime()}},policy:function(){},set:function(a){var b;2==a.length&&Ra(a[1])?b=n(a[1]):3==a.length&&g(a[1])&&(b={},Ra(a[2])||ua(a[2])?b[a[1]]=n(a[2]):b[a[1]]=a[2]);if(b){
...
Z.a.f=["google"],function(){(function(a){Z.__f=a;Z.__f.b="f";Z.__f.g=!0;Z.__f.priorityOverride=0})(function(a){var b=ll("gtm.referrer",1)||H.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?pe(re(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):kl(String(b)):String(b)})}();

Z.a.u=["google"],function(){var a=function(b){return{toString:function(){return b}}};(function(b){Z.__u=b;Z.__u.b="u";Z.__u.g=!0;Z.__u.priorityOverride=0})(function(b){var c;b.vtp_customUrlSource?c=b.vtp_customUrlSource:c=ll("gtm.url",1);c=c||il();var d=b[a("vtp_component")];if(!d||"URL"==d)return kl(String(c));var e=re(String(c)),f;if("QUERY"===d)a:{var h=b[a("vtp_multiQueryKeys").toString()],k=b[a("vtp_queryKey").toString()]||"",l=b[a("vtp_ignoreEmptyQueryParam").toString()],p;h?ua(k)?p=k:p=String(k).replace(/\s+/g,
"").split(","):p=[String(k)];for(var m=0;m<p.length;m++){var r=pe(e,"QUERY",void 0,void 0,p[m]);if(void 0!=r&&(!l||""!==r)){f=r;break a}}f=void 0}else f=pe(e,d,"HOST"==d?b[a("vtp_stripWww")]:void 0,"PATH"==d?b[a("vtp_defaultPages")]:void 0,void 0);return f})}();
...
Z.a.ua=["google"],function(){function a(m,r){if(Nc()&&!d[m]){var t=function(){var q=Yg(),u="gtm"+Bd(),v=l(r),w={name:u};k(v,w,!0);q("create",m,w);q(function(){q.remove(u)})};Qc(t,C.J);Qc(t,C.m);d[m]=!0}}var b,c={},d={},e=function(m){Wc(function(){p(m)},[C.J,C.m])},f={name:!0,clientId:!0,sampleRate:!0,siteSpeedSampleRate:!0,alwaysSendReferrer:!0,allowAnchor:!0,allowLinker:!0,cookieName:!0,cookieDomain:!0,cookieExpires:!0,cookiePath:!0,cookieUpdate:!0,cookieFlags:!0,legacyCookieDomain:!0,legacyHistoryImport:!0,
storage:!0,useAmpClientId:!0,storeGac:!0,_cd2l:!0},h={allowAnchor:!0,allowLinker:!0,alwaysSendReferrer:!0,anonymizeIp:!0,cookieUpdate:!0,exFatal:!0,forceSSL:!0,javaEnabled:!0,legacyHistoryImport:!0,nonInteraction:!0,useAmpClientId:!0,useBeacon:!0,storeGac:!0,allowAdFeatures:!0,allowAdPersonalizationSignals:!0,_cd2l:!0},k=function(m,r,t){var q=0;if(m)for(var u in m)if(m.hasOwnProperty(u)&&(t&&f[u]||!t&&void 0===f[u])){var v=h[u]?Da(m[u]):m[u];"anonymizeIp"!=u||v||(v=void 0);r[u]=v;q++}return q},l=
function(m){var r={};m.vtp_gaSettings&&n(am(m.vtp_gaSettings.vtp_fieldsToSet,"fieldName","value"),r);n(am(m.vtp_fieldsToSet,"fieldName","value"),r);Uc(C.J)||(r.storage="none");Uc(C.m)||(r.allowAdFeatures=!1,r.storeGac=!1);m.vtp_transportUrl&&(r._x_19=m.vtp_transportUrl);return r},
p=function(m){function r(na,S){void 0!==S&&D("set",na,S)}var t={},q={},u={},v={};if(m.vtp_gaSettings){var w=m.vtp_gaSettings;n(am(w.vtp_contentGroup,"index","group"),q);n(am(w.vtp_dimension,"index","dimension"),u);n(am(w.vtp_metric,"index","metric"),v);var y=n(w);y.vtp_fieldsToSet=void 0;y.vtp_contentGroup=void 0;y.vtp_dimension=void 0;y.vtp_metric=void 0;m=n(m,y)}n(am(m.vtp_contentGroup,"index","group"),q);n(am(m.vtp_dimension,"index","dimension"),u);n(am(m.vtp_metric,"index","metric"),v);var x=
l(m),A=$g(m.vtp_functionName);if(ra(A)){var B="",z="";m.vtp_setTrackerName&&"string"==typeof m.vtp_trackerName?""!==m.vtp_trackerName&&(z=m.vtp_trackerName,B=z+"."):(z="gtm"+Bd(),B=z+".");var D=function(na){var S=[].slice.call(arguments,0);S[0]=B+S[0];A.apply(window,S)},F=function(na,S){return void 0===S?S:na(S)},L=function(na,S){if(S)for(var mb in S)S.hasOwnProperty(mb)&&D("set",na+mb,S[mb])},P=function(){},Q={name:z};k(x,Q,!0);var N=m.vtp_trackingId||t.trackingId;A("create",N,Q);D("set","&gtm",Ih(!0));Nc()&&(D("set","&gcs",Vc()),a(N,m));x._x_19&&(null==lc&&delete x._x_19,
x._x_20&&!c[z]&&(c[z]=!0,A(dh(z,String(x._x_20)))));m.vtp_enableRecaptcha&&D("require","recaptcha","recaptcha.js");(function(na,S){void 0!==m[S]&&D("set",na,m[S])})("nonInteraction","vtp_nonInteraction");L("contentGroup",q);L("dimension",u);L("metric",v);var ba={};k(x,ba,!1)&&D("set",ba);var V;
m.vtp_enableLinkId&&D("require","linkid","linkid.js");D("set","hitCallback",function(){var na=x&&x.hitCallback;ra(na)&&na();m.vtp_gtmOnSuccess()});if("TRACK_EVENT"==m.vtp_trackType){m.vtp_enableEcommerce&&(D("require","ec","ec.js"),P());var M={hitType:"event",eventCategory:String(m.vtp_eventCategory||t.category),eventAction:String(m.vtp_eventAction||t.action),eventLabel:F(String,m.vtp_eventLabel||t.label),eventValue:F(Ca,m.vtp_eventValue||
t.value)};k(V,M,!1);D("send",M);}else if("TRACK_SOCIAL"==m.vtp_trackType){}else if("TRACK_TRANSACTION"==m.vtp_trackType){}else if("TRACK_TIMING"==
m.vtp_trackType){}else if("DECORATE_LINK"==m.vtp_trackType){}else if("DECORATE_FORM"==m.vtp_trackType){}else if("TRACK_DATA"==m.vtp_trackType){}else{m.vtp_enableEcommerce&&(D("require","ec","ec.js"),P());if(m.vtp_doubleClick||"DISPLAY_FEATURES"==m.vtp_advertisingFeaturesType){var ta=
"_dc_gtm_"+String(m.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");D("require","displayfeatures",void 0,{cookieName:ta})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==m.vtp_advertisingFeaturesType){var Bc="_dc_gtm_"+String(m.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");D("require","adfeatures",{cookieName:Bc})}V?D("send","pageview",V):D("send","pageview");}if(!b){var rd=m.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js";m.vtp_useInternalVersion&&!m.vtp_useDebugVersion&&(rd="internal/"+rd);b=!0;var ok=uh(x._x_19,"/analytics.js"),eo=O("https:","http:","//www.google-analytics.com/"+rd,x&&!!x.forceSSL);T("analytics.js"===rd&&ok?ok:eo,function(){var na=Yg();na&&na.loaded||m.vtp_gtmOnFailure();},m.vtp_gtmOnFailure)}}else I(m.vtp_gtmOnFailure)};
...
(b.vtp_enableCrossDomain&&!1===b.vtp_acceptIncoming||(b.vtp_enableCrossDomain||xf())&&Pf(a,k));Mf(k);Rf(["aw","dc"],k);$f(h,k);var l=e;if(b.vtp_enableCrossDomainFeature&&b.vtp_enableCrossDomain&&b.vtp_linkerDomains){var p=b.vtp_linkerDomains.toString().replace(/\s+/g,"").split(",");Qf(a,p,b.vtp_urlPosition,!!b.vtp_formDecoration,l)}var m=ll(C.M);ki(!1,void 0!=m&&!1!==m);b.vtp_enableUrlPassthroughFeature&&b.vtp_enableUrlPassthrough&&Tf()})}();

Z.a.aev=["google"],function(){function a(q,u){var v=he(q,"gtm");if(v)return v[u]}function b(q,u,v,w){w||(w="element");var y=q+"."+u,x;if(m.hasOwnProperty(y))x=m[y];else{var A=a(q,w);if(A&&(x=v(A),m[y]=x,r.push(y),35<r.length)){var B=r.shift();delete m[B]}}return x}function c(q,u,v){var w=a(q,t[u]);return void 0!==w?w:v}function d(q,u){if(!q)return!1;var v=e(il());ua(u)||(u=String(u||"").replace(/\s+/g,"").split(","));for(var w=[v],y=0;y<u.length;y++)if(u[y]instanceof RegExp){if(u[y].test(q))return!1}else{var x=
u[y];if(0!=x.length){if(0<=e(q).indexOf(x))return!1;w.push(e(x))}}return!$l(q,w)}function e(q){p.test(q)||(q="http://"+q);return pe(re(q),"HOST",!0)}function f(q,u,v){switch(q){case "SUBMIT_TEXT":return b(u,"FORM."+q,h,"formSubmitElement")||v;case "LENGTH":var w=b(u,"FORM."+q,k);return void 0===w?v:w;case "INTERACTED_FIELD_ID":return l(u,"id",v);case "INTERACTED_FIELD_NAME":return l(u,"name",v);case "INTERACTED_FIELD_TYPE":return l(u,"type",v);case "INTERACTED_FIELD_POSITION":var y=a(u,"interactedFormFieldPosition");
return void 0===y?v:y;case "INTERACT_SEQUENCE_NUMBER":var x=a(u,"interactSequenceNumber");return void 0===x?v:x;default:return v}}function h(q){switch(q.tagName.toLowerCase()){case "input":return uc(q,"value");case "button":return vc(q);default:return null}}function k(q){if("form"===q.tagName.toLowerCase()&&q.elements){for(var u=0,v=0;v<q.elements.length;v++)Gk(q.elements[v])&&u++;return u}}function l(q,u,v){var w=a(q,"interactedFormField");return w&&uc(w,u)||v}var p=/^https?:\/\//i,m={},r=[],t={ATTRIBUTE:"elementAttribute",
...
v;case "TEXT":return b(u,w,vc)||v;case "URL":var x;a:{var A=String(a(u,"elementUrl")||v||""),B=re(A),z=String(q.vtp_component||"URL");switch(z){case "URL":x=A;break a;case "IS_OUTBOUND":x=d(A,q.vtp_affiliatedDomains);break a;default:x=pe(B,z,q.vtp_stripWww,q.vtp_defaultPages,q.vtp_queryKey)}}return x;case "ATTRIBUTE":var D;if(void 0===q.vtp_attribute)D=c(u,w,v);else{var F=q.vtp_attribute,L=a(u,"element");D=L&&uc(L,F)||v||""}return D;case "MD":var P=q.vtp_mdValue,Q=b(u,"MD",Sk);return P&&Q?Vk(Q,P)||
v:Q||v;case "FORM":return f(String(q.vtp_component||"SUBMIT_TEXT"),u,v);default:return c(u,w,v)}})}();
Z.a.gas=["google"],function(){(function(a){Z.__gas=a;Z.__gas.b="gas";Z.__gas.g=!0;Z.__gas.priorityOverride=0})(function(a){var b=n(a),c=b;c[Gb.Ia]=null;c[Gb.pf]=null;var d=b=c;d.vtp_fieldsToSet=d.vtp_fieldsToSet||[];var e=d.vtp_cookieDomain;void 0!==e&&(d.vtp_fieldsToSet.push({fieldName:"cookieDomain",value:e}),delete d.vtp_cookieDomain);return b})}();
...
function p(w){var y=!0;y&&b.push(m)}Tg();var m={google_basket_transaction_type:"purchase",google_conversion_domain:"",google_conversion_id:k.vtp_conversionId,google_conversion_label:k.vtp_conversionLabel,google_conversion_value:k.vtp_conversionValue||0,google_remarketing_only:!1,onload_callback:k.vtp_gtmOnSuccess,
gtm_onFailure:k.vtp_gtmOnFailure,google_gtm:Ih()};k.vtp_rdp&&(m.google_restricted_data_processing=!0);void 0!=ll(C.M)&&!1!==ll(C.M)&&(m.google_gtm_url_processor=function(w){return w=ug(w)});var r=function(w){return function(y,x,A){var B="DATA_LAYER"==w?ll(A):k[x];B&&(m[y]=B)}},t=r("JSON");t("google_conversion_currency","vtp_currencyCode");t("google_conversion_order_id","vtp_orderId");k.vtp_enableProductReporting&&(t=r(k.vtp_productReportingDataSource),t("google_conversion_merchant_id","vtp_awMerchantId",
"aw_merchant_id"),t("google_basket_feed_country","vtp_awFeedCountry","aw_feed_country"),t("google_basket_feed_language","vtp_awFeedLanguage","aw_feed_language"),t("google_basket_discount","vtp_discount","discount"),t("google_conversion_items","vtp_items","items"),m.google_conversion_items&&m.google_conversion_items.map&&(m.google_conversion_items=m.google_conversion_items.map(function(w){return{value:w.price,quantity:w.quantity,item_id:w.id}})));var q=function(w,y){void 0!==y&&((m.google_additional_conversion_params=
m.google_additional_conversion_params||{})[w]=y)},u=function(w){return function(y,x,A,B){var z="DATA_LAYER"==w?ll(A):k[x];B(z)&&q(y,z)}};k.vtp_transportUrl&&(m.google_transport_url=k.vtp_transportUrl);var v=uh(k.vtp_transportUrl,"/pagead/conversion_async.js");v||(v=-1==navigator.userAgent.toLowerCase().indexOf("firefox")?"//www.googleadservices.com/pagead/conversion_async.js":"https://www.google.com/pagead/conversion_async.js");
...
qf(!1)._up&&q("gtm_up","1");l();(function(){Nc()?Wc(function(){l();var w=Uc(C.m),y=!w&&void 0!=ll(C.M)&&!1!==ll(C.M);!k.vtp_transportUrl&&y&&(m.google_transport_url="https://pagead2.googlesyndication.com/");q("gcs",Vc());p(w);w||Qc(function(){l();m=n(m);!k.vtp_transportUrl&&m.google_transport_url&&delete m.google_transport_url;q("gcs",Vc());q("gcu","1");p(!0)},C.m)},[C.m]):p(!0)})();a||(a=!0,T(v,f(),e(v)))};
...
Z.a.lcl=[],function(){function a(){var c=W("document"),d=0,e=function(f){var h=f.target;if(h&&3!==f.which&&!(f.Kg||f.timeStamp&&f.timeStamp===d)){d=f.timeStamp;h=xc(h,["a","area"],100);if(!h)return f.returnValue;var k=f.defaultPrevented||!1===f.returnValue,l=Dk("lcl",k?"nv.mwt":"mwt",0),p;p=k?Dk("lcl","nv.ids",[]):Dk("lcl","ids",[]);if(p.length){var m=zk(h,"gtm.linkClick",p);if(b(f,h,c)&&!k&&l&&h.href){var r=String(ul(h,"rel")||""),t=!!wa(r.split(" "),function(v){return"noreferrer"===v.toLowerCase()});
t&&E(36);var q=W((ul(h,"target")||"_self").substring(1)),u=!0;if(ml(m,pk(function(){var v;if(v=u&&q){var w;a:if(t){var y;try{y=new MouseEvent(f.type)}catch(x){if(!c.createEvent){w=!1;break a}y=c.createEvent("MouseEvents");y.initEvent(f.type,!0,!0)}y.Kg=!0;f.target.dispatchEvent(y);w=!0}else w=!1;v=!w}v&&(q.location.href=ul(h,"href"))}),l))u=!1;else return f.preventDefault&&f.preventDefault(),f.returnValue=!1}else ml(m,function(){},l||2E3);return!0}}};sc(c,"click",e,!1);sc(c,"auxclick",e,!1)}function b(c,
...
var h=c.vtp_uniqueTriggerId||"0";if(d){var k=function(p){return Math.max(f,p)};Ck("lcl","mwt",k,0);e||Ck("lcl","nv.mwt",k,0)}var l=function(p){p.push(h);return p};Ck("lcl","ids",l,[]);e||Ck("lcl","nv.ids",l,[]);rl("lcl")||(a(),sl("lcl"));I(c.vtp_gtmOnSuccess)})}();
